...
import com.ansari.distributed_lovable.account_service.dto.subscription.*;
import com.ansari.distributed_lovable.account_service.service.PaymentProcessor;
        ...
        try {
            ...
            if(deserializer.getObject().isPresent()){
                ...
                try {
                    ...
                    log.error("Unsafe deserialization for event{}:{}", event.getType(),e.getMessage());
