package com.ansari.distributed_lovable.api_gateway.filter;

import com.ansari.distributed_lovable.api_gateway.config.SecurityProperties;
import com.ansari.distributed_lovable.api_gateway.error.ApiError;
import com.ansari.distributed_lovable.api_gateway.service.JwtGatewayService;
...
public class GatewayJwtAuthFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if(isPublic){
            log.info("Public route, contains:{}",path);
