package com.ansari.distributed_lovable.intelligence_service.consumer;

import com.ansari.distributed_lovable.common_lib.enums.ChatEventStatus;
    ...
    public void handleSagaResponse(FileStoreResponseEvent response){
        ...
        chatEventRepository.findBySagaId(response.sagaId()).ifPresent(event->{
            ...
            if(response.success()){
                ...
                log.warn("Saga {} FAILED. Deleting eent.",response.sagaId());
