package com.ansari.distributed_lovable.intelligence_service.client;
...
public interface WorkspaceClient {
    ...
    boolean checkPermission(@PathVariable Long projectId, @RequestParam ProjectPermission permission);
}
